    ...
    <div className="flex justify-center items-center w-full flex-col">
      <section className="flex justify-center items-center max-w-[1220px] w-full mx-10 h-screen flex-row">
        <div className=" mt-20 md:mt-0 px-10 relative z-50">
          <h1 className="text-[40px] xs:text-[64px] xl:text-[96px] text-yellow leading-[100%] font-bold ">
            Looking <br></br> Beyond <br></br>the Vision
          </h1>
          <p className="text-text text-[15px] xs:text-[20px] leading-[150%] font-semibold max-w-[400px] w-90% lg:w-[400px] pt-5">
