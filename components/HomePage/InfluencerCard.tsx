  ...
  return (
    <>
      <div className=" rounded-3xl grid-container max-w-[1220px] w-[90%] overflow-hidden bg-backgroundaccent md:h-[1500px] 1xl:h-[500px] grid md:grid-cols-1 md:grid-rows-3 1xl:grid-cols-3 1xl:grid-rows-1 gap-10 p-10 place-items-center">
        <div   data-aos="fade-down" data-aos-duration="1000" data-aos-delay="100"  className="rounded-3xl w-full h-full flex justify-center items-center py-10  flex-col hover:bg-background duration-300">
        ...
        <div   data-aos="fade-down" data-aos-duration="1000" data-aos-delay="200"  className="rounded-3xl w-full h-full flex justify-center items-center py-10  flex-col hover:bg-background duration-300">
          <div className="w-[200px] xs:w-[316px] pt-10 h-auto">
        ...
        <div   data-aos="fade-down" data-aos-duration="1000" data-aos-delay="300" className="rounded-3xl w-full h-full flex justify-center items-center py-10 flex-col hover:bg-background duration-300">
          <div className="w-[200px] xs:w-[316px] pt-10 h-auto">
