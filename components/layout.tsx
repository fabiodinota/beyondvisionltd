  ...
  return (
    <div className="bg-[#161616]">
      <Head>
        ...
        <meta name="description" content="Beyond Vision LTD is an influencer marketing and management agency based out of the United
        ...
        <meta property="og:description" content="Beyond Vision LTD is an influencer marketing and management agency based out of the United
         Kingdom, but not limited to working inside of the United Kingdom as the agency works with various influencers & companies of
          all different calibers all around the globe."/>
        ...
        <meta property="twitter:url" content="https://www.beyondvisionltd.org"/>
        <meta name="twitter:title" content="Beyond Vision LTD"/>
        <meta name="twitter:description" content="Beyond Vision LTD is an influencer marketing and management agency based out of the United
         Kingdom, but not limited to working inside of the United Kingdom as the agency works with various influencers & companies of
          all different calibers all around the globe." />
