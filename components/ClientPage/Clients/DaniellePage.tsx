...
import Main from "../../../public/images/ClientsImages/Danielle.png";
      ...
      <section className="flex justify-center items-center max-w-[1220px] w-[90%] xl:w-full  flex-col mt-[100px] xl:mt-[150px]">
        <div className="flex justify-center items-center flex-wrap-reverse mt-8 md:mt-14 xl:mt-0 xl:flex-nowrap px-0 xl:mx-5 pb-[100px] flex-row pt-10">
          ...
          <div className="pl-0 xl:pl-10 max-w-[900px] w-[90%] pb-10 xl:pb-0 xl:w-[610px]">
            ...
            >
              My name is Danielle, I am from London, UK. My content is based on lifestyle, beauty, and fashion. I started my account in March of 2020 as a side hobby and something to do, since then it has grown and become a big passion of mine. I try to post around 3-4 times every day. My hobbies include doing makeup, watching movies/series, socializing with friends, and filming content for my page.
            </p>
            <br />
            ...
            >
              <div className="pr-2 pt-2">
                <a href="https://www.instagram.com/_danielleburke_/">
              ...
              <div className="px-2 w-[48px] origin-top p-0 h-auto">
                <a
                  ...
                  href="https://www.tiktok.com/@_danielleburke_"
                >
