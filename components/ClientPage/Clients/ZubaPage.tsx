...
import Main from "../../../public/images/ClientsImages/zuba.png";
      ...
      <section className="flex justify-center items-center max-w-[1220px] w-[90%] xl:w-full  flex-col mt-[100px] xl:mt-[150px]">
        <div className="flex justify-center items-center flex-wrap-reverse mt-8 md:mt-14 xl:mt-0 xl:flex-nowrap px-0 xl:mx-5 pb-[100px] flex-row pt-10">
          ...
          <div className="pl-0 xl:pl-10 max-w-[900px] w-[90%] pb-10 xl:pb-0 xl:w-[610px]">
            ...
            >
Zuba is a content creator and streamer from the big apple New York City. He began creating content on tiktok in 2020 and fell in love with content creation since. Zuba mainly creates call of duty content but is excited to venture out within the esports industry and beyond. He loves interacting with his community and sharing back the love that his fans give him and can&ldquo;t wait for what the future holds.
            </p>
            <br />
            <br />
            <div
            ...
            >
              <div className="pr-2 pt-2">
                <a href="https://www.instagram.com/zubair_salim/">
              ...
              <div className="px-2 w-[48px] origin-top p-0 h-auto">
                <a
                  ...
                  href="https://www.tiktok.com/@zubaax_?lang=en"
                >
